      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="backward.php">Backward Chaining</a>
                ...
                <div class="card-body">
                  ...
                  function backward($input, $i)
                  {
                    ...
                    if($check){
                      ...
                      // $result=$db_connect->query("TRUNCATE TABLE `working_memory_table`");
                      echo "<form method='post' action='backward.php'>";
                  ...
                  if(!isset($_POST['epoch'])) { 
                    ...
                    echo "<form action='backward.php' method='POST'><div class='form-group'><select class='form-control' name='choice'>";
                    ...
                    if(!$ketemu){
                      ...
                      // $p = $_POST['epoch'];
                      // echo "Question ".$p." :  <h3 class='m-0 font-weight-bold'>".$attribute[$p]."</h3><br><br>";
